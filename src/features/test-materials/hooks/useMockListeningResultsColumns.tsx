  ...
  return [
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        const item = materials.find((mat: any) => mat.type === "listening");
        const material_id = item ? item.listening_material_id : null;

        return (
          <>
            <NavLink
              to={`/teacher/students/${student_id}/mock/listening/${material_id}`}
              className={"text-blue-500"}
            >
              View
            </NavLink>
